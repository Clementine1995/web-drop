...
> [手写各种](https://github.com/qianlongo/fe-handwriting)
...
> 原文[用 setTimeout 和 clearTimeout 简单实现 setInterval 与 clearInterval](https://juejin.im/post/5cd273d3e51d453ae03507ee)
...
是用 apply 或 call 来实现的。有一点要注意，对象中函数的简写定义方式，与箭头函数是没有 prototype 的。
